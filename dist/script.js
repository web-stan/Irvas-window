...
/* harmony import */ var _node_modules_wow_js_dist_wow__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/wow.js/dist/wow */ "./node_modules/wow.js/dist/wow.js");
/* harmony import */ var _node_modules_wow_js_dist_wow__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_wow_js_dist_wow__WEBPACK_IMPORTED_MODULE_1__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])('.glazing__slider', '.glazing__block', '.glazing__content', 'active', 'flex');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])('.decoration__slider', '.no_click', '.decoration__content > div ', 'after_click');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])('.balcon-icons', '.balcon-icons__img', '.big-img > img', 'do-image-more', 'inline-block'); // tabs окон
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer__container', deadline);
  Object(_modules_images__WEBPACK_IMPORTED_MODULE_7__["default"])();
  document.querySelector('.footer__logo').addEventListener('click', function (e) {
  ...
  var wow = new _node_modules_wow_js_dist_wow__WEBPACK_IMPORTED_MODULE_1___default.a({
    boxClass: 'wow',
...
var changeModalState = function changeModalState(state) {
  var windowShape = document.querySelectorAll('.balcon-icons__img'),
      windowWidth = document.querySelectorAll('#width'),
      windowHeight = document.querySelectorAll('#height'),
      windowType = document.querySelectorAll('#view_type'),
      windowProfile = document.querySelectorAll('.checkbox');
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#height'); // let actionOnElems = (event, elem, prop) => {
  ...
  var actionOnElems = function actionOnElems(event, elem, prop) {
  ...
  actionOnElems('change', windowProfile, 'profile'); // windowForm.forEach((item, index) => {
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusMessage.style.marginTop = '-13.5px';
...
var modals = function modals() {
  function bindModul(triggerSelector, modalSelector, closeSelector) {
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function showTabContent() {
    ...
    // content[i].style.display = 'block'; // старый вариант
...
var timer = function timer(id, deadline) {
  var getTime = function getTime(endtime) {
    ...
    seconds = Math.floor(time / 1000 % 60),
        //  колл. минут, остаток в секундах
    minutes = Math.floor(time / 1000 / 60 % 60),
        // колл. часов, остаток в минутах
    hours = Math.floor(time / 1000 / 60 / 60 % 24),
        // колл. суток, остаток в часах
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.glazing__slider').slick({
    infinite: true,
    slidesToShow: 5,
    slidesToScroll: 1,
    responsive: [{
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.decoration__slider').slick({
    infinite: true,
    slidesToShow: 4,
    slidesToScroll: 1,
    responsive: [{
